          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", gap: 20, marginTop: 14, color: "var(--muted)", fontSize: 14, flexWrap: "wrap" }}>
              ...
              {campaign.minFollowerCount ? (
                <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--muted)" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                  {campaign.minFollowerCount.toLocaleString()} followers required
                </span>
              ) : null}
            </div>
          </div>
