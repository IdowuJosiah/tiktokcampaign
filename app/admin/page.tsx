  ...
  return (
    <AppShell>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: "var(--muted)", fontSize: 15, margin: "6px 0 0" }}>Live health, today&apos;s activity and pending actions</p>
      </div>
      ...
      <div style={{ background: "var(--panel)", border: "1px solid var(--line)", borderRadius: 14, marginBottom: 20, overflow: "hidden" }}>
        ...
        {liveCampaigns.length === 0 ? (
          <div style={{ padding: "32px 24px", color: "var(--muted)", fontSize: 14 }}>No live campaigns right now.</div>
        ) : (
          <div>
            {liveCampaigns.map((c, i) => (
              <Link
                ...
                style={{ display: "grid", gridTemplateColumns: "1fr auto auto auto", gap: 16, alignItems: "center", padding: "15px 24px", borderBottom: i < liveCampaigns.length - 1 ? "1px solid var(--line)" : "none", textDecoration: "none", color: "inherit" }}
              >
                <div>
                  <div style={{ fontSize: 14, fontWeight: 600, color: "var(--foreground)" }}>{c.title}</div>
                  <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 2 }}>{c.brand}</div>
                </div>
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontSize: 13, color: "var(--muted)" }}>Pool</div>
                  <div style={{ fontSize: 14, fontWeight: 700 }}>{c.rewardPool}</div>
                </div>
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontSize: 13, color: "var(--muted)" }}>Deadline</div>
                  <div style={{ fontSize: 14 }}>{c.deadline}</div>
                </div>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--muted)" strokeWidth="2"><path d="M9 18l6-6-6-6"/></svg>
              </Link>
            ))}
          </div>
        )}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <Link href="/admin/campaigns" style={{ display: "flex", alignItems: "center", gap: 14, padding: 14, border: "1px solid var(--line)", borderRadius: 11, cursor: "pointer", textDecoration: "none", color: "inherit" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 13, color: "var(--muted)" }}>24h SLA</div>
              </div>
              <span style={{ fontSize: 20, fontWeight: 700, color: "#00d9a3" }}>{pendingReview}</span>
            </Link>

            <Link href="/admin/disputes" style={{ display: "flex", alignItems: "center", gap: 14, padding: 14, border: "1px solid var(--line)", borderRadius: 11, cursor: "pointer", textDecoration: "none", color: "inherit" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 13, color: "var(--muted)" }}>48h SLA for appeal review</div>
              </div>
            ...
            <Link href="/admin/submissions" style={{ display: "flex", alignItems: "center", gap: 14, padding: 14, border: "1px solid var(--line)", borderRadius: 11, cursor: "pointer", textDecoration: "none", color: "inherit" }}>
              ...
              <span style={{ fontSize: 20, fontWeight: 700, color: "var(--foreground)" }}>{totalSubs}</span>
            </Link>
          </div>
        </div>
        ...
        <div style={{ background: "var(--panel)", border: "1px solid var(--line)", borderRadius: 14, padding: 24 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ display: "flex", gap: 12, padding: 13, background: "rgba(0,217,163,0.04)", border: "1px solid rgba(0,217,163,0.2)", borderRadius: 11 }}>
              ...
              <div>
                <div style={{ fontSize: 13, color: "var(--foreground)", fontWeight: 700 }}>Paystack API</div>
                <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 2 }}>Deposit and payout endpoints nominal</div>
              </div>
            </div>
            <div style={{ display: "flex", gap: 12, padding: 13, background: "rgba(0,217,163,0.04)", border: "1px solid rgba(0,217,163,0.2)", borderRadius: 11 }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#00d9a3" strokeWidth="2" style={{ flexShrink: 0, marginTop: 1 }}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="M22 4 12 14.01l-3-3"/></svg>
              <div>
                <div style={{ fontSize: 13, color: "var(--foreground)", fontWeight: 700 }}>TikTok API</div>
                <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 2 }}>Video verification pipeline healthy</div>
              </div>
            </div>
            <div style={{ display: "flex", gap: 12, padding: 13, background: "rgba(0,217,163,0.04)", border: "1px solid rgba(0,217,163,0.2)", borderRadius: 11 }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#00d9a3" strokeWidth="2" style={{ flexShrink: 0, marginTop: 1 }}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="M22 4 12 14.01l-3-3"/></svg>
              <div>
                <div style={{ fontSize: 13, color: "var(--foreground)", fontWeight: 700 }}>Scoring pipeline</div>
                <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 2 }}>All systems operational</div>
              </div>
            </div>
          </div>
        </div>
