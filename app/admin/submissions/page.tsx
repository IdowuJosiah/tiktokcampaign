  ...
  return (
    <AppShell>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: "#99a1af", fontSize: 15, margin: "6px 0 0" }}>Review creator submissions and approve or reject them</p>
      </div>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, overflow: "hidden" }}>
          {pending.length === 0 ? (
            ...
            pending.map((s, i) => (
              <Link key={s.id} href={`/admin/submissions/${s.id}`} style={{ display: "flex", alignItems: "center", gap: 16, padding: "16px 22px", borderBottom: i < pending.length - 1 ? "1px solid rgba(255,255,255,0.05)" : "none", textDecoration: "none", color: "inherit" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ color: "#99a1af", fontSize: 13, marginTop: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{s.link}</div>
                </div>
                ...
                <div style={{ fontSize: 13, color: "#99a1af", marginLeft: 4 }}>{s.views}</div>
              </Link>
            ))
          )}
        </div>
        ...
        <div>
          ...
          <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, overflow: "hidden" }}>
            {reviewed.slice(0, 10).map((s, i) => (
              <Link key={s.id} href={`/admin/submissions/${s.id}`} style={{ display: "flex", alignItems: "center", gap: 16, padding: "14px 22px", borderBottom: i < Math.min(reviewed.length, 10) - 1 ? "1px solid rgba(255,255,255,0.05)" : "none", textDecoration: "none", color: "inherit" }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ color: "#99a1af", fontSize: 12, marginTop: 1 }}>{s.handle}</div>
                </div>
                ...
                <div style={{ fontSize: 14, fontWeight: 700, color: "#fff", minWidth: 70, textAlign: "right" }}>{s.reward}</div>
              </Link>
            ))}
          </div>
        </div>
