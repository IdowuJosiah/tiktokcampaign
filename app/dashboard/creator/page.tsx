    ...
    <AppShell>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 20, marginBottom: 28 }}>
        <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: 22, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <div style={{ color: "#99a1af", fontSize: 13, marginBottom: 10 }}>Wallet Balance</div>
        ...
        <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: 22, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <div style={{ color: "#99a1af", fontSize: 13, marginBottom: 10 }}>Active Submissions</div>
        ...
        <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: 22, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <div style={{ color: "#99a1af", fontSize: 13, marginBottom: 10 }}>Total Earned</div>
        ...
        <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: 22, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <div style={{ color: "#99a1af", fontSize: 13, marginBottom: 10 }}>Open Campaigns</div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        {campaigns.length === 0 ? (
          ...
          campaigns.map((c) => (
            <div key={c.id} style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: 24, display: "flex", gap: 24 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                  <div>
                    ...
                    <div style={{ color: "#99a1af", fontSize: 14, marginTop: 3 }}>{c.brand}</div>
                  </div>
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontSize: 28, fontWeight: 700, color: "#00d9a3", lineHeight: 1 }}>{c.rewardPool}</div>
                    <div style={{ color: "#99a1af", fontSize: 13, marginTop: 2 }}>reward pool</div>
                  </div>
                </div>
                <p style={{ color: "#d1d5dc", fontSize: 14, margin: "14px 0 0" }}>{c.brief}</p>
                <div style={{ display: "flex", gap: 8, marginTop: 14, flexWrap: "wrap" }}>
                  {[c.requiredHashtag, c.requiredSound].filter(Boolean).map((tag) => (
                    <span key={tag} style={{ fontSize: 12, color: "#99a1af", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 6, padding: "4px 9px" }}>{tag}</span>
                  ))}
                </div>
