      ...
      <div className="login-card">
        ...
        <div className="login-body">
          <form action={logIn}>
            ...
            <a href="/api/tiktok/connect?mode=auth" className="auth-oauth-btn" style={{ marginTop: 8, display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontSize: 14, color: "#fff", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 8, cursor: "pointer", height: 44, textDecoration: "none" }}>
