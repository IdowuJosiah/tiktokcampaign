  ...
  return (
    <AppShell>
      <div style={{ maxWidth: 760 }}>
        <Link href="/campaigns" style={{ display: "inline-flex", alignItems: "center", gap: 8, color: "#99a1af", fontSize: 14, textDecoration: "none", marginBottom: 18 }}>
        ...
        {selectedMission && (
          <p style={{ color: "#99a1af", fontSize: 15, margin: "6px 0 24px" }}>{selectedMission.title} · {selectedMission.brand} · {selectedMission.rewardPool}</p>
        )}
        ...
        {!canSubmit ? (
          <div style={{ background: "rgba(255,137,4,0.06)", border: "1px solid rgba(255,137,4,0.25)", borderRadius: 14, padding: "28px 32px" }}>
            ...
            <p style={{ color: "#99a1af", fontSize: 15, margin: "0 0 20px", lineHeight: 1.5 }}>Connect your TikTok account from your profile page before submitting campaign videos.</p>
          ...
          <div>
            <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: 22, marginBottom: 18 }}>
