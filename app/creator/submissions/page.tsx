      ...
      {grouped.size === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          {Array.from(grouped.entries()).map(([missionId, group]) => (
            <div key={missionId} style={{ background: "var(--panel)", border: "1px solid var(--line)", borderRadius: 14, padding: 22 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {group.items.map((submission) => (
                  <div key={submission.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, padding: "12px 14px", background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 10 }}>
