    ...
    <AppShell>
      <div style={{ maxWidth: 980 }}>
        ...
        <div style={{ background: "rgba(0,217,163,0.06)", border: "1px solid rgba(0,217,163,0.25)", borderRadius: 14, padding: "18px 22px", marginBottom: 18 }}>
          ...
          <p style={{ fontSize: 15, color: "var(--foreground)", margin: 0, lineHeight: 1.5 }}>{mission.brief}</p>
        </div>
          ...
          <div style={{ background: "#fff", border: "1px solid var(--line)", borderRadius: 14, padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ color: "var(--muted)", fontSize: 13 }}>Hashtag</span>
                <span style={{ fontSize: 14, fontWeight: 600 }}>{mission.requiredHashtag}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ color: "var(--muted)", fontSize: 13 }}>Sound</span>
                <span style={{ fontSize: 14, fontWeight: 600 }}>{mission.requiredSound}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ color: "var(--muted)", fontSize: 13 }}>Views req.</span>
          ...
          <div style={{ background: "#fff", border: "1px solid var(--line)", borderRadius: 14, padding: 20 }}>
            ...
            <ul style={{ margin: 0, paddingLeft: 18, display: "flex", flexDirection: "column", gap: 8 }}>
              {mission.requirements.map((r) => (
                <li key={r} style={{ fontSize: 14, color: "var(--foreground)", lineHeight: 1.4 }}>{r}</li>
              ))}
            </ul>
          </div>
        </div>
