  ...
  return (
    <form action={signUp}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        {role === "creator" && (
          <a
            href="/api/tiktok/connect?mode=auth"
            style={{ height: 44, display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontSize: 14, color: "#fff", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 8, cursor: "pointer", textDecoration: "none" }}
          >
