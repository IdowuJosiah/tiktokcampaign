const errors: Record<string, string> = {
  ...
  no_payout_tiers: "Add at least one payout tier.",
  invalid_tier_views: "Each tier needs a valid minimum view count.",
  invalid_tier_payout: "Each tier needs a payout amount greater than ₦0.",
  duplicate_tier_views: "Each tier must have a unique view threshold.",
